/**
 * @generated SignedSource<<7eeb8a18c9ef7017746e20392907c364>>
...
export type UserListPaginationFragment$variables = {
  count?: number | null | undefined;
  cursor?: string | null | undefined;
  id: string;
  tabOption?: ListTabOptions | null | undefined;
};
export type UserListPaginationFragment$data = {
  readonly node: {
    readonly " $fragmentSpreads": FragmentRefs<"FeedListFragment">;
  } | null | undefined;
};
export type UserListPaginationFragment = {
  response: UserListPaginationFragment$data;
  variables: UserListPaginationFragment$variables;
};
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "UserListPaginationFragment",
    "selections": [
      {
        "alias": null,
        "args": (v4/*: any*/),
