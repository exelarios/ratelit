...
export type ExploreFeedPaginationFragment$variables = {
  count?: number | null | undefined;
  cursor?: string | null | undefined;
  id: string;
};
export type ExploreFeedPaginationFragment$data = {
  readonly node: {
    readonly " $fragmentSpreads": FragmentRefs<"ExploreFeedFragment">;
  } | null | undefined;
};
export type ExploreFeedPaginationFragment = {
  response: ExploreFeedPaginationFragment$data;
  variables: ExploreFeedPaginationFragment$variables;
};
